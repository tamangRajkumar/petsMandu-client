...
const CardsVerticalAligned = ({key, description, image, address }) => {
  return (
    <div key={key} className=" border border-gray-100 shadow-lg rounded-2xl  my-20 mx-20  py-6 px-4 hover:shadow-xl transform  duration-150 ">
      {/* body Hotel lists */}

      
        <div className="flex mx-10 ">
          <div>
            <img className=" h-72 w-72 rounded-xl" src={image} alt="" />
          </div>
