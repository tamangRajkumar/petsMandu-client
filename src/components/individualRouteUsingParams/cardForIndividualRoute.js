...
function cardForIndividualRoute(props){
    ...
    return(
        ...
        {/* First Image */}
        <img src= {props.img} alt="" className="h-96 w-auto  mt-5 shadow-xl transform hover:scale-105 duration-300 hover:shadow-xl"/>
       
       <div className="hidden md:hidden lg:flex space-x-5 ml-8">
        <div className="">

        <img src= {props.img} alt="" className="h-40 w-auto  cursor-pointer mt-5  shadow-xl transform hover:scale-105 hover:shadow-xl duration-300"/>
        <img src= {props.img} alt="" className="h-40 w-auto cursor-pointer  mt-5  shadow-xl transform hover:scale-105 hover:shadow-xl duration-300"/>
        ...
        <img src= {props.mapImg } alt="" className="flex items-center justify-between m-auto content-center"/>
        </div>
        
        <div>
        <p className="text-center font-bold  text-3xl mt-20 mb-5">Rating and Commenting Section</p>
